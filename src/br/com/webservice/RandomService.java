 ...
 * 
 */
@WebServiceClient(name = "RandomService", targetNamespace = "http://webService.com.br/", wsdlLocation = "http://localhost:8080/random?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RANDOMSERVICE_QNAME = new QName("http://webService.com.br/", "RandomService");
    ...
    public Random getRandomPort() {
        return super.getPort(new QName("http://webService.com.br/", "RandomPort"), Random.class);
    }
    ...
    public Random getRandomPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.com.br/", "RandomPort"), Random.class, features);
    }
